...
E int FDECL(dokick_ext, (BOOLEAN_P));
#endif
...
#ifdef ADVENT_CALENDAR
E void FDECL(fill_advent_calendar, (BOOLEAN_P));
#endif
...
E boolean FDECL(parse_color_definition, (char *));
...
E int FDECL(nhcolor_to_RGB, (int));
...
E void NDECL(tele);
E void FDECL(new_tele, (BOOLEAN_P));
E int NDECL(dotele);
...
E void FDECL(check_tutorial_command, (CHAR_P));
