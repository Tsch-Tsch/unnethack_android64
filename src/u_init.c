...
#define R_DAGGERS	1
	{ SHORT_P_SWORD, 0, WEAPON_CLASS, 1, UNDEF_BLESS },
...
#define S_ARROWS	3
	...
	{ SHORT_P_SWORD, 0, WEAPON_CLASS, 1, UNDEF_BLESS }, /* wakizashi */
...
static struct inv_sub { short race_pm, item_otyp, subs_otyp; } inv_subs[] = {
    ...
    { PM_ELF,	SHORT_P_SWORD,		ELVEN_SHORT_P_SWORD     },
 ...
 /* { PM_ELF,	SMALL_SHIELD,		ELVEN_SHIELD	      }, */
    ...
    { PM_ORC,	SHORT_P_SWORD,		ORCISH_SHORT_P_SWORD    },
    ...
    { PM_DWARF, SHORT_P_SWORD,		DWARVISH_SHORT_P_SWORD  },
 ...
 */
STATIC_OVL void
knows_class(register CHAR_P sym)
{
	register int ct;
...
# endif
	...
	case PM_BARBARIAN:
		if (rn2(100) >= 50) {	/* see above comment */
		    ...
		    Barbarian[B_MINOR].trotyp = SHORT_P_SWORD;
		}
		ini_inv(Barbarian);
	...
	case PM_ELF:
	    ...
	    knows_object(ELVEN_SHORT_P_SWORD);
	...
	case PM_DWARF:
	    ...
	    knows_object(DWARVISH_SHORT_P_SWORD);
	...
	case PM_ORC:
	    ...
	    knows_object(ORCISH_SHORT_P_SWORD);
