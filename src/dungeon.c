...
xchar
ledger_to_dnum(XCHAR_P ledgerno)
{
	register int i;
...
xchar
ledger_to_dlev(XCHAR_P ledgerno)
{
...
void
next_level(BOOLEAN_P at_stairs)
{
...
void
prev_level(BOOLEAN_P at_stairs)
{
	if (at_stairs && u.ux == sstairs.sx && u.uy == sstairs.sy) {
...
static char *
seen_string(XCHAR_P x, const char *obj)
{
