 ...
 */
STATIC_OVL void
god_zaps_you(ALIGNTYP_P resp_god)
{
	if (u.uswallow) {
...
STATIC_OVL void
fry_by_god(ALIGNTYP_P resp_god)
{
	char killerbuf[64];
 ...
 */
STATIC_OVL boolean
water_prayer(BOOLEAN_P bless_water)
{
    register struct obj* otmp;
...
const char *
align_gname(ALIGNTYP_P alignment)
{
    const char *gnam;
...
const char *
halu_gname(ALIGNTYP_P alignment)
{
...
/* deity's title */
const char *
align_gtitle(ALIGNTYP_P alignment)
{
