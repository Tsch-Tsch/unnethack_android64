...
STATIC_VAR NEARDATA const short skill_names_indices[P_NUM_SKILLS] = {
	0,                DAGGER,         KNIFE,        AXE,
	PICK_AXE,         SHORT_P_SWORD,    BROADSWORD,   LONG_SWORD,
...
static const NEARDATA short hwep[] = {
	  ...
	  MORNING_STAR, ELVEN_SHORT_P_SWORD, DWARVISH_SHORT_P_SWORD, SHORT_P_SWORD,
	  ORCISH_SHORT_P_SWORD, MACE, AXE, DWARVISH_SPEAR, SILVER_SPEAR,
...
/*ARGSUSED*/
STATIC_OVL boolean
can_advance(int skill, BOOLEAN_P speedy)
{
