...
void
fall_asleep(int how_long, BOOLEAN_P wakeup_msg)
{
	stop_occupation();
 ...
 */
boolean
start_timer(long when, SHORT_P kind, SHORT_P func_index, genericptr_t arg)
{
    timer_element *gnu;
 ...
 */
long
stop_timer(SHORT_P func_index, genericptr_t arg)
{
...
void
relink_timers(BOOLEAN_P ghostly)
{
    timer_element *curr;
    unsigned nid;
