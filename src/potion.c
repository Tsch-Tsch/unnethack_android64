...
void
make_confused(long xtime, BOOLEAN_P talk)
{
	long old = HConfusion;
...
void
make_stunned(long xtime, BOOLEAN_P talk)
{
	long old = HStun;
...
void
make_vomiting(long xtime, BOOLEAN_P talk)
{
	long old = Vomiting;
...
void
make_blinded(long xtime, BOOLEAN_P talk)
{
	long old = Blinded;
